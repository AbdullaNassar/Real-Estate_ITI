...
export default function ListItemCard({ list }) {
  ...
  return (
    <div className="relative p-2 h-full flex flex-col shadow-xl bg-gray-50 text-center rounded-md">
      ...
      <span className='bg-gray-50 absolute rounded-full flex items-center gap-1 p-1 font-semibold left-3 justify-center text-gray-800 top-4'><span> <FaFireFlameCurved className='text-primarry'/></span> Poublar home </span>
      <div className="grow">
        <img
          src={list.photos[0]}
          alt="list pic"
