      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-6 text-sm leading-relaxed">
          ...
          <section className="bg-gray-50 shadow-md rounded-xl p-5 hover:shadow-lg transition-shadow duration-300">
            ...
            <ul className="list-disc list-inside space-y-1">
              <li>
                <span className="font-medium">{t("about.whyChooseList.item1title")}</span>{" "}
                {t("about.whyChooseList.item1")}
              </li>
              <li>
                <span className="font-medium">{t("about.whyChooseList.item2title")}</span>{" "}
                {t("about.whyChooseList.item2")}
              </li>
               <li>
                <span className="font-medium">{t("about.whyChooseList.item3title")}</span>{" "}
