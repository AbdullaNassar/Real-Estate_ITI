  ...
  export default function Contact() {
    ...
    className="max-w-md w-full mx-auto mt-14 mb-8 p-6 bg-white rounded-2xl shadow-2xl hover:shadow-2xl transition-shadow duration-300"
  >
    ...
    {/* Name */}
    <div className="mb-4">
      <label className="block text-gray-700 font-medium mb-2 text-sm">Enter Your Name</label>
      <input
        name="name"
        type="text"
    ...
    {/* Email */}
    <div className="mb-4">
      <label className="block text-gray-700 font-medium mb-2 text-sm">Enter Your Email</label>
      <input
        name="email"
        type="email"
        onChange={formik.handleChange}
