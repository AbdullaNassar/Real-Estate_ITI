...
export default function HowItWork() {
  ...
  useAOS();
  return (
    <section data-aos="fade-down" className="py-20 bg-gray-50 text-gray-700">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-4">{t("howItWorks.title")}</h2>
          <p className="text-xl ">{t("howItWorks.subtitle")}</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center group">
            ...
            <p className=" leading-relaxed">{t("howItWorks.searchText")}</p>
          </div>
          ...
          <div className="text-center group">
            ...
            <p className=" leading-relaxed">{t("howItWorks.bookText")}</p>
          </div>
          ...
          <div className="text-center group">
            ...
            <p className=" leading-relaxed">{t("howItWorks.enjoyText")}</p>
          </div>
        </div>
      </div>
    </section>
